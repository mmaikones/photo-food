...
values
  (
    ...
    'delivery',
    '1:1',
    array['iFood', 'Rappi', 'Uber Eats', '99Food'],
    $$STYLE: Commercial Delivery App Photography
...
- "I want to order this right now" feeling$$,
  ...
  (
    ...
    'fine-dining',
    '4:5',
    array['Instagram Feed', 'Website', 'Menu Premium'],
    $$STYLE: Dark & Moody Fine Dining Photography
...
- Evokes taste through visual richness$$,
  ...
  (
    ...
    'menu',
    '4:3',
    array['Cardápio Digital', 'PDF Menu', 'Website Gallery'],
    $$STYLE: Overhead Flat Lay Food Photography
...
- Inviting and accessible$$,
  ...
  (
    ...
    'social-media',
    '9:16',
    array['Instagram Stories', 'TikTok', 'Reels', 'Status WhatsApp'],
    $$STYLE: Bold Social Media Vertical Photography
...
- FOMO-inducing$$,
  ...
  (
    ...
    'premium',
    '1:1',
    array['Website Hero', 'Instagram Feed', 'Print Advertising'],
    $$STYLE: High-End Minimalist Product Photography
...
- Luxury without ostentation$$,
    '/templates/minimalist-clean.jpg',
    true
  ),
  (
    'rustico-artesanal',
    ...
    'artisan',
    '4:5',
    array['Instagram Feed', 'Pinterest', 'Blog', 'Cardápio Artesanal'],
    $$STYLE: Rustic Farmhouse Food Photography
...
- Cozy Sunday morning vibes$$,
  ...
  (
    ...
    'fast-food',
    '4:5',
    array['iFood', 'Instagram Feed', 'Outdoor', 'Delivery Apps'],
    $$STYLE: Craveable Fast Food Hero Photography
...
- "I need this NOW" urgency$$,
  ...
  (
    ...
    'patisserie',
    '4:5',
    array['Instagram Feed', 'Website', 'Menu Degustação', 'Pinterest'],
    $$STYLE: Fine Patisserie Photography
...
- Gift-worthy presentation$$,
  ...
  (
    ...
    'beverages',
    '4:5',
    array['Instagram Feed', 'Menu Bebidas', 'Cardápio Digital'],
    $$STYLE: Refreshing Beverage Photography
...
- Summer vibes$$,
    '/templates/drinks-refreshing.jpg',
    true
  ),
  (
    'saudavel-fitness',
    ...
    'healthy',
    '1:1',
    array['Instagram Feed', 'App Fitness', 'Blog Saúde', 'Cardápio Fit'],
    $$STYLE: Clean Healthy Lifestyle Photography
...
on conflict (slug) do update set
  ...
  platform_suggestions = excluded.platform_suggestions,
